...
import { products as initialCatalogProducts, Product, formatNPR, CATEGORIES, BRANDS } from "@/lib/products";
import {
  OMSUN_CATEGORIES,
  INITIAL_ORDERS,
  INITIAL_CUSTOMERS,
...
export function AdminDashboardPage() {
  ...
  const totalRevenue = ordersList
    ...
    .reduce((acc, curr) => acc + curr.totalAmount, 18450000);
  ...
  return (
    <div className="flex min-h-dvh bg-[#F2FBF4] dark:bg-[#071A12] text-[#173226] dark:text-slate-100 font-sans">
      ...
      <Sheet open={mobileSidebarOpen} onOpenChange={setMobileSidebarOpen}>
        <SheetContent side="left" className="p-0 w-72 bg-[#12342B] border-none">
          <AdminSidebar
            activeSection={activeSection}
            onSelectSection={(sec) => {
        ...
        <main className="flex-1 p-3.5 sm:p-6 lg:p-8 space-y-5 sm:space-y-6 max-w-7xl mx-auto w-full">
          ...
          {activeSection === "overview" && (
            <div className="space-y-5 sm:space-y-6">
              {/* Executive KPI Cards Grid — 1 Col Mobile, 2 Col Tablet, 6 Col Desktop */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4">
                ...
                <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-b from-white via-white to-[#F2FBF4]/50 dark:from-[#0c241c] dark:to-[#071A12] p-4 sm:p-4.5 border border-[#E2EDE7] dark:border-white/10 shadow-xs transition-all duration-400 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1.5 hover:scale-[1.015] hover:border-[#38B46A] hover:shadow-xl hover:shadow-[#38B46A]/15 border-t-2 border-t-[#38B46A]">
                  <div className="flex items-center justify-between">
                    <span className="text-slate-500 text-[10px] font-extrabold uppercase tracking-wider">Total Revenue</span>
                ...
                <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-b from-white via-white to-[#EFF8FF]/50 dark:from-[#0c241c] dark:to-[#071A12] p-4 sm:p-4.5 border border-[#E2EDE7] dark:border-white/10 shadow-xs transition-all duration-400 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1.5 hover:scale-[1.015] hover:border-[#2F80ED] hover:shadow-xl hover:shadow-[#2F80ED]/15 border-t-2 border-t-[#2F80ED]">
                  <div className="flex items-center justify-between">
                    <span className="text-slate-500 text-[10px] font-extrabold uppercase tracking-wider">Total Orders</span>
                ...
                <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-b from-white via-white to-[#ECFDF3]/50 dark:from-[#0c241c] dark:to-[#071A12] p-4 sm:p-4.5 border border-[#E2EDE7] dark:border-white/10 shadow-xs transition-all duration-400 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1.5 hover:scale-[1.015] hover:border-[#12342B] hover:shadow-xl hover:shadow-[#12342B]/15 border-t-2 border-t-[#12342B]">
                  <div className="flex items-center justify-between">
                    <span className="text-slate-500 text-[10px] font-extrabold uppercase tracking-wider">Catalog SKUs</span>
                ...
                <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-b from-white via-white to-[#FFFBEB]/50 dark:from-[#0c241c] dark:to-[#071A12] p-4 sm:p-4.5 border border-[#E2EDE7] dark:border-white/10 shadow-xs transition-all duration-400 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1.5 hover:scale-[1.015] hover:border-[#F4B400] hover:shadow-xl hover:shadow-[#F4B400]/20 border-t-2 border-t-[#F4B400]">
                  <div className="flex items-center justify-between">
                    <span className="text-slate-500 text-[10px] font-extrabold uppercase tracking-wider">Low Stock Alert</span>
                ...
                <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-b from-white via-white to-[#F2FBF4]/50 dark:from-[#0c241c] dark:to-[#071A12] p-4 sm:p-4.5 border border-[#E2EDE7] dark:border-white/10 shadow-xs transition-all duration-400 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1.5 hover:scale-[1.015] hover:border-[#38B46A] hover:shadow-xl hover:shadow-[#38B46A]/15 border-t-2 border-t-[#38B46A]">
                  <div className="flex items-center justify-between">
                    <span className="text-slate-500 text-[10px] font-extrabold uppercase tracking-wider">Clients</span>
                    <div className="flex size-8 rounded-xl bg-emerald-500/10 border border-emerald-500/20 items-center justify-center text-[#38B46A] group-hover:scale-110 transition-transform">
                  ...
                  <div className="mt-1 text-[11px] text-[#38B46A] font-bold">
                    3 VIP Contractors
                  </div>
                </div>
                ...
                <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-b from-white via-white to-[#EFF8FF]/50 dark:from-[#0c241c] dark:to-[#071A12] p-4 sm:p-4.5 border border-[#E2EDE7] dark:border-white/10 shadow-xs transition-all duration-400 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1.5 hover:scale-[1.015] hover:border-[#2F80ED] hover:shadow-xl hover:shadow-[#2F80ED]/15 border-t-2 border-t-[#2F80ED]">
                  <div className="flex items-center justify-between">
                    <span className="text-slate-500 text-[10px] font-extrabold uppercase tracking-wider">NEA Net-Meter</span>
                    <div className="flex size-8 rounded-xl bg-sky-500/10 border border-sky-500/20 items-center justify-center text-[#2F80ED] group-hover:scale-110 transition-transform">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-xs font-extrabold text-amber-950 dark:text-amber-200">
                        {lowStockCount} Hardware Item(s) Need Reordering
                      </h4>
                      <p className="text-[11px] text-amber-800/80 dark:text-amber-300 font-medium">
                        SunCore Edge LED Panel 40W and other SKUs are near zero stock.
                      </p>
                    </div>
                  </div>
                  <Button
                    onClick={() => setActiveSection("inventory")}
                    className="h-8.5 px-4 w-full sm:w-auto rounded-xl bg-amber-400 hover:bg-amber-300 text-black text-xs font-extrabold cursor-pointer shadow-md shadow-amber-400/20 transition-all hover:scale-105"
                  >
                    View Inventory &rarr;
                  </Button>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-6">
                ...
                <div className="lg:col-span-2 rounded-3xl bg-white dark:bg-[#0c241c] p-4.5 sm:p-6 border border-[#E2EDE7] dark:border-white/10 shadow-sm space-y-4 hover:border-[#38B46A]/40 transition-colors">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Monthly NPR Sales breakdown (Jan - Aug 2026)</p>
                    </div>
                ...
                <div className="rounded-3xl bg-white dark:bg-[#0c241c] p-4.5 sm:p-6 border border-[#E2EDE7] dark:border-white/10 shadow-sm space-y-4 flex flex-col justify-between hover:border-[#2F80ED]/40 transition-colors">
                  <div>
                    ...
                    <p className="text-xs text-slate-500">Sales share across OMSUN hardware segments</p>
                  </div>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <PieChart>
                        ...
                        <RechartsTooltip
                          ...
                          formatter={(val: any) => [`${val}% Share`, "Sales"]}
                        />
                      </PieChart>
                    </ResponsiveContainer>
                  </div>
              ...
              <div className="rounded-3xl bg-white dark:bg-[#0c241c] p-4.5 sm:p-6 border border-[#E2EDE7] dark:border-white/10 shadow-sm space-y-4">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="text-xs text-slate-500">Latest customer purchases awaiting dispatch</p>
                  </div>
                  <Button
                  ...
                  >
                    View All Orders ({ordersList.length}) &rarr;
                  </Button>
                </div>
                ...
                <div className="block sm:hidden space-y-3">
                  {ordersList.slice(0, 4).map((ord) => (
                    <div key={ord.id} className="p-3.5 rounded-2xl bg-[#F8FBF8] dark:bg-white/5 border border-slate-200/80 dark:border-white/10 space-y-2 text-xs">
                      <div className="flex items-center justify-between">
                        <span className="font-mono font-extrabold text-[#173226] dark:text-white">{ord.id}</span>
                        <span
                      ...
                      <div className="font-bold text-[#173226] dark:text-white">{ord.customerName}</div>
                      <div className="flex justify-between items-center pt-1 border-t border-slate-200/60 dark:border-white/10">
                        <span className="font-mono font-extrabold text-[#38B46A]">{formatNPR(ord.totalAmount)}</span>
                        <button
                ...
                <div className="hidden sm:block overflow-x-auto rounded-2xl border border-slate-200/80 dark:border-white/10">
                  <table className="w-full text-left text-xs border-collapse">
                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-white/5 font-medium">
                      {ordersList.slice(0, 4).map((ord) => (
                        <tr key={ord.id} className="hover:bg-[#F2FBF4]/80 dark:hover:bg-white/5 transition-colors">
            ...
            <div className="space-y-5 sm:space-y-6">
              ...
              <div className="block sm:hidden space-y-3">
                {productsList
                  ...
                  .map((prod) => (
                    <div key={prod.id} className="p-4 rounded-2xl bg-white dark:bg-[#0c241c] border border-[#E2EDE7] dark:border-white/10 shadow-xs space-y-3">
                      <div className="flex items-center gap-3">
                        <img src={prod.image} alt="" className="size-12 rounded-xl object-cover border border-slate-200 dark:border-white/10 shrink-0" />
                        <div className="min-w-0 flex-1">
                          <div className="text-xs font-extrabold text-[#173226] dark:text-white truncate">{prod.name}</div>
                          <div className="text-[11px] text-[#38B46A] font-bold">{prod.category} • {prod.brand}</div>
                      ...
                      <div className="flex items-center justify-between pt-2 border-t border-slate-100 dark:border-white/10 text-xs">
                        <div className="font-mono font-extrabold text-[#38B46A]">{formatNPR(prod.price)}</div>
                        <button
                          onClick={() => {
                  ...
                  <table className="w-full text-left text-xs border-collapse">
                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-white/5 font-medium">
                      {productsList
                        ...
                        .map((prod) => (
                          <tr key={prod.id} className="hover:bg-[#F2FBF4]/80 dark:hover:bg-white/5 transition-colors">
                            <td className="p-4 font-bold text-[#173226] dark:text-white flex items-center gap-3">
                              <img src={prod.image} alt="" className="size-11 rounded-xl object-cover border border-slate-200 dark:border-white/10 shadow-xs" />
                              <div>
                                <div className="text-xs font-extrabold">{prod.name}</div>
                                <div className="text-[11px] text-slate-400 font-mono font-normal">SKU: {prod.id}</div>
                              </div>
                            </td>
                            <td className="p-4">
                              <div className="font-bold text-slate-700 dark:text-slate-300">{prod.category}</div>
                              <div className="text-[10px] font-bold text-[#38B46A]">{prod.brand}</div>
                            </td>
              ...
              <div className="flex items-center justify-between flex-wrap gap-2">
                <div>
                  <h3 className="font-display font-extrabold text-lg text-[#173226] dark:text-white">
                    OMSUN Renewable Hardware Portfolio Categories
                  </h3>
                  <p className="text-xs text-slate-500">10 core energy categories deployed across Nepal</p>
                </div>
                <Button
                    ...
                    >
                      ...
                      <div className="pt-3 border-t border-slate-100 dark:border-white/10 flex items-center justify-between text-xs font-bold text-slate-600 dark:text-slate-300">
                        ...
                        <button
                          ...
                          className="text-[#38B46A] hover:underline font-extrabold flex items-center gap-1 group-hover:translate-x-1 transition-transform"
                        >
                          View Items &rarr;
                        </button>
                      </div>
            ...
            <div className="space-y-5 sm:space-y-6">
              <div className="flex items-center justify-between flex-wrap gap-3">
                <div>
                  ...
                  <p className="text-xs text-slate-500">Live stock counts, threshold monitors & reorder alerts</p>
                </div>
              ...
              <div className="block sm:hidden space-y-3">
                {productsList.map((prod) => (
                  <div key={prod.id} className="p-4 rounded-2xl bg-white dark:bg-[#0c241c] border border-[#E2EDE7] dark:border-white/10 shadow-xs space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="font-bold text-[#173226] dark:text-white text-xs">{prod.name}</div>
                      <span
                        className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold border ${
                          prod.stock > 10
                            ? "bg-[#ECFDF3] text-[#38B46A] border-[#38B46A]/30"
                      ...
                      >
                        {prod.stock > 10 ? "In Stock" : prod.stock > 0 ? "Low Stock Alert" : "Out of Stock"}
                      </span>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-xs pt-1 border-t border-slate-100 dark:border-white/10">
                      ...
                      <span className="font-mono font-extrabold text-[#173226] dark:text-white">{prod.stock} Units</span>
                    </div>
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-white/5 font-medium">
                    {productsList.map((prod) => (
                      <tr key={prod.id} className="hover:bg-[#F2FBF4]/80 dark:hover:bg-white/5 transition-colors">
                        ...
                        <td className="p-4 font-mono text-slate-400 text-[11px]">Today 14:30 GMT+5:45</td>
                        <td className="p-4 text-right">
                          <Button
                            onClick={() => {
                              setSelectedStockProduct(prod);
            ...
            <div className="space-y-5 sm:space-y-6">
                ...
                <div className="flex gap-2 overflow-x-auto pb-1 sm:pb-0 scrollbar-none">
                  {["All", "Pending", "Processing", "Completed", "Cancelled"].map((st) => (
                    <button
                      ...
                      className={`px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-xl text-xs font-extrabold transition-all cursor-pointer shrink-0 ${
              ...
              <div className="block sm:hidden space-y-3">
                {ordersList
                  .filter(
                    (o) =>
                      (selectedOrderStatusFilter === "All" || o.orderStatus === selectedOrderStatusFilter) &&
                      (o.id.toLowerCase().includes(orderQuery.toLowerCase()) ||
                        o.customerName.toLowerCase().includes(orderQuery.toLowerCase()))
                  )
                  .map((ord) => (
                    <div key={ord.id} className="p-4 rounded-2xl bg-white dark:bg-[#0c241c] border border-[#E2EDE7] dark:border-white/10 shadow-xs space-y-3 text-xs">
                      <div className="flex items-center justify-between">
                        <span className="font-mono font-extrabold text-[#173226] dark:text-white">{ord.id}</span>
                        <span
                          className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold border ${
                      ...
                      <div className="flex items-center justify-between pt-2 border-t border-slate-100 dark:border-white/10">
                        <span className="font-mono font-extrabold text-[#38B46A] text-sm">{formatNPR(ord.totalAmount)}</span>
                        <Button
                          onClick={() => setSelectedOrderForDrawer(ord)}
                          className="h-8 px-3 rounded-xl bg-[#12342B] text-white text-xs font-bold"
                        >
                          Inspect Order &rarr;
                        </Button>
                      </div>
                  ...
                  <table className="w-full text-left text-xs border-collapse">
                    <thead>
                      <tr className="border-b border-[#E2EDE7] dark:border-white/10 bg-[#F2FBF4] dark:bg-white/5 font-extrabold uppercase text-slate-500">
                        ...
                        <th className="p-4">Total Amount (NPR)</th>
                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-white/5 font-medium">
                      {ordersList
                        ...
                        .map((ord) => (
                          <tr key={ord.id} className="hover:bg-[#F2FBF4]/80 dark:hover:bg-white/5 transition-colors">
                            <td className="p-4 font-mono font-extrabold text-[#173226] dark:text-white">
                              {ord.id}
                            </td>
                            <td className="p-4">
                              <div className="font-bold text-[#173226] dark:text-white">{ord.customerName}</div>
                            ...
                            <td className="p-4 font-bold">{ord.items.length} Product(s)</td>
                            <td className="p-4 font-mono font-black text-[#38B46A] text-sm">
                              {formatNPR(ord.totalAmount)}
                            </td>
                            <td className="p-4">
                              <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-slate-100 dark:bg-white/10">
                            ...
                            <td className="p-4 text-right">
                              <Button
                                onClick={() => setSelectedOrderForDrawer(ord)}
                                className="h-8 px-3 rounded-xl bg-[#12342B] hover:bg-[#1a4237] text-white font-bold text-xs cursor-pointer shadow-xs transition-all hover:scale-105"
                              >
                                View Order &rarr;
                              </Button>
                            </td>
            ...
            <div className="space-y-5 sm:space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500">Commercial & residential clients across Nepal</p>
                </div>
              </div>
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-white/5 font-medium">
                    {customersList.map((cust) => (
                      <tr key={cust.id} className="hover:bg-[#F2FBF4]/80 dark:hover:bg-white/5">
                        ...
                        <td className="p-4">
                          <div className="font-mono text-slate-700 dark:text-slate-300">{cust.email}</div>
                          <div className="text-[10px] font-mono text-slate-400">{cust.phone}</div>
                        </td>
                        <td className="p-4 font-bold text-slate-600 dark:text-slate-300">{cust.city}</td>
            ...
            <div className="space-y-5 sm:space-y-6">
              <div className="flex items-center justify-between flex-wrap gap-2">
                <div>
                  ...
                  <p className="text-xs text-slate-500">Active checkout promotional codes & campaign limits</p>
                </div>
                <Button
                    ...
                    {couponsList.map((cpn) => (
                      <tr key={cpn.id} className="hover:bg-[#F2FBF4]/80 dark:hover:bg-white/5">
                        ...
                        <td className="p-4 font-bold text-[#173226] dark:text-white">
                          {cpn.discountType === "Percentage" ? `${cpn.discountValue}% OFF` : `Rs ${cpn.discountValue} OFF`}
                        </td>
            ...
            <div className="space-y-5 sm:space-y-6">
              <div className="flex items-center justify-between flex-wrap gap-3">
                <div>
                  ...
                  <p className="text-xs text-slate-500">Comprehensive sales, inventory turns & customer growth analytics</p>
                </div>
                <Button
            ...
            <div className="space-y-5 sm:space-y-6">
              <div className="flex items-center justify-between flex-wrap gap-2">
                <div>
                  ...
                  <p className="text-xs text-slate-500">Official manufacturers (Dyna, Excite, Luminous, Smarten)</p>
                </div>
                <Button
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-4.5">
                {partnersList.map((prt, idx) => {
                  const colors = [
                    { border: "border-t-[#38B46A]", badge: "bg-[#ECFDF3] text-[#38B46A] border-[#38B46A]/30" },
                    { border: "border-t-[#2F80ED]", badge: "bg-[#EFF8FF] text-[#2F80ED] border-[#2F80ED]/30" },
                    { border: "border-t-[#F4B400]", badge: "bg-[#FFFBEB] text-[#D97706] border-[#F4B400]/30" },
                    { border: "border-t-[#12342B]", badge: "bg-[#F2FBF4] text-[#12342B] border-[#12342B]/30" },
                  ];
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <span className={`px-3 py-1 rounded-full text-[10px] font-extrabold border ${activeTheme.badge}`}>
                          {prt.status}
                        </span>
                      </div>
          ...
          {activeSection === "settings" && (
            <div className="space-y-5 sm:space-y-6">
              <div>
                ...
                <p className="text-xs text-slate-500">Configure store details, tax registration, and permissions</p>
              </div>
              ...
              <div className="rounded-3xl bg-white dark:bg-[#0c241c] p-4.5 sm:p-6 border border-[#E2EDE7] dark:border-white/10 shadow-sm space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                  <div className="space-y-1.5">
                    <label className="font-bold text-[#173226] dark:text-slate-200">Company Legal Name</label>
                    <Input defaultValue="OMSUN Solar & Renewable Energy Pvt. Ltd." className="rounded-xl" />
                  </div>
                  <div className="space-y-1.5">
                    <label className="font-bold text-[#173226] dark:text-slate-200">Nepal PAN / VAT Number</label>
                    <Input defaultValue="601982340" className="rounded-xl font-mono" />
                  </div>
                  <div className="space-y-1.5">
                    <label className="font-bold text-[#173226] dark:text-slate-200">Default Currency</label>
                    <Input defaultValue="NPR (Nepalese Rupee)" disabled className="rounded-xl font-bold text-[#38B46A]" />
                  </div>
                  <div className="space-y-1.5">
                    <label className="font-bold text-[#173226] dark:text-slate-200">Nepal Value Added Tax (VAT)</label>
      ...
      <CouponFormModal
        ...
        onSaveCoupon={(cpn) => setCouponsList((prev) => [cpn, ...prev])}
      />
      ...
      <PartnerFormModal
        ...
        onSavePartner={(prt) => setPartnersList((prev) => [prt, ...prev])}
      />
    </div>
  );
}
